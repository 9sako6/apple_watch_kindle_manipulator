...
// @name         Apple Watch Kindle Manipulator
...
const installPage = await readFile("public/index.html", "utf8");
await writeFile("dist/index.html", installPage.replaceAll("{{VERSION}}", version));
